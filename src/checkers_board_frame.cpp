...
// bool CheckersBoardFrame::killCallback(turtlesim::srv::Kill::Request& req, 
...
// bool CheckersBoardFrame::clearCallback(std_srvs::Empty::Request&, std_srvs::Empty::Response&)
// {
...
// bool CheckersBoardFrame::resetCallback(std_srvs::Empty::Request&, std_srvs::Empty::Response&)
// {
...
std::string CheckersBoardFrame::spawnTurtle(const std::string& name, float x, float y, float angle)
{
	return spawnTurtle(name, x, y, angle, rand() % turtle_images_.size());
}

std::string CheckersBoardFrame::spawnTurtle(const std::string& name, float x, float y, float angle, size_t index)
{
...
void CheckersBoardFrame::paintEvent(QPaintEvent*)
{
